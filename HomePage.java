...
public class HomePage implements ActionListener{
	...
	ImageIcon luckPic = new ImageIcon("adam.jpg"); // image of luckiest player
	...
	// course pictures
	ImageIcon i1 = new ImageIcon("CoursePictures/LuigiCircuit.jpg");
	ImageIcon i2 = new ImageIcon("CoursePictures/MooMooMeadows.jpg");
	ImageIcon i3 = new ImageIcon("CoursePictures/MushroomGorge.png");
	ImageIcon i4 = new ImageIcon("CoursePictures/ToadFactory.jpg");
	ImageIcon i5 = new ImageIcon("CoursePictures/MarioCircuit.jpg");
	ImageIcon i6 = new ImageIcon("CoursePictures/CoconutMall.jpg");
	ImageIcon i7 = new ImageIcon("CoursePictures/DKSummit.jpg");
	ImageIcon i8 = new ImageIcon("CoursePictures/WarioGoldMine.png");
	ImageIcon i9 = new ImageIcon("CoursePictures/DaisyCircuit.jpg");
	ImageIcon i10 = new ImageIcon("CoursePictures/KoopaCape.png");
	ImageIcon i11 = new ImageIcon("CoursePictures/MapleTreeway.png");
	ImageIcon i12 = new ImageIcon("CoursePictures/GrumbleVolcano.jpg");
	ImageIcon i13 = new ImageIcon("CoursePictures/DryDryRuins.jpg");
	ImageIcon i14 = new ImageIcon("CoursePictures/MoonviewHighway.png");
	ImageIcon i15 = new ImageIcon("CoursePictures/BowserCastle.jpg");
	ImageIcon i16 = new ImageIcon("CoursePictures/RainbowRoad.jpg");
	ImageIcon i17 = new ImageIcon("CoursePictures/PeachBeach.png");
	ImageIcon i18 = new ImageIcon("CoursePictures/YoshiFalls.jpg");
	ImageIcon i19 = new ImageIcon("CoursePictures/GhostValley2.png");
	ImageIcon i20 = new ImageIcon("CoursePictures/MarioRaceway.jpg");
	ImageIcon i21 = new ImageIcon("CoursePictures/SherbertLand.jpg");
	ImageIcon i22 = new ImageIcon("CoursePictures/ShyGuyBeach.png");
	ImageIcon i23 = new ImageIcon("CoursePictures/DelfinoSquare.jpg");
	ImageIcon i24 = new ImageIcon("CoursePictures/WaluigiStadium.jpg");
	ImageIcon i25 = new ImageIcon("CoursePictures/DesertHills.png");
	ImageIcon i26 = new ImageIcon("CoursePictures/BowserCastle3.jpg");
	ImageIcon i27 = new ImageIcon("CoursePictures/DKJungleParkway.jpg");
	ImageIcon i28 = new ImageIcon("CoursePictures/GCNMarioCircuit.jpg");
	ImageIcon i29 = new ImageIcon("CoursePictures/MarioCircuit3.jpg");
	ImageIcon i30 = new ImageIcon("CoursePictures/PeachGardens.jpg");
	ImageIcon i31 = new ImageIcon("CoursePictures/DKMountain.jpg");
	ImageIcon i32 = new ImageIcon("CoursePictures/N64BowserCastle.jpg");
	...
	// cup images
	ImageIcon i33 = new ImageIcon("CupPictures/MushroomCup.jpg");
	ImageIcon i34 = new ImageIcon("CupPictures/FlowerCup.jpg");
	ImageIcon i35 = new ImageIcon("CupPictures/StarCup.jpg");
	ImageIcon i36 = new ImageIcon("CupPictures/SpecialCup.jpg");
	ImageIcon i37 = new ImageIcon("CupPictures/ShellCup.png");
	ImageIcon i38 = new ImageIcon("CupPictures/BananaCup.jpg");
	ImageIcon i39 = new ImageIcon("CupPictures/LeafCup.png");
	ImageIcon i40 = new ImageIcon("CupPictures/LightningCup.jpg");
	...
	private int totalLuck() {
		...
		try {
			...
			scan = new Scanner(new File("StatFiles/courseStats"));
			scan.useDelimiter("[,\n]");
			...
			if (total > total2) {
				luckPic = new ImageIcon("misc/adam.jpg");
			} else {
				luckPic = new ImageIcon("misc/brian.jpg");
